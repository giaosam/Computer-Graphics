...
var iBufferCubeID, tBufferCubeID, vBufferCubeID; //立方体的3个buffer
var vCubeTextureCoords, vCubePosition;
...
window.onload = function init() {
    ...
    tBufferCubeID = gl.createBuffer();
    gl.bindBuffer(gl.ARRAY_BUFFER, tBufferCubeID);
