...
var lightPosition = vec4(0, 4, 0, 0.0);
var lightPosition2 = vec4(-3, 0, 0, 0.0);

var lightAmbient = vec4(1, 1, 1, 1.0);//环境光
var lightDiffuse = vec4(1, 1, 1, 1.0);//散射光
var lightSpecular = vec4(0, 0, 0, 1.0);//反射光

var materialAmbient = vec4(0.6, 0.4, 0.4, 0);
var materialDiffuse = vec4(1, 0.8, 0, 1.0);
var materialSpecular = vec4(0, 0, 0, 1.0);
//var materialAmbient = vec4(0.7, 0.7, 0.7, 0);
...
function render() {
    ...
    if (!attack) {
       ...
       // lightPosition2[0] += 2 * Math.sin(bulbT2);
       // lightPosition2[2] += 2 * Math.cos(bulbT2);
